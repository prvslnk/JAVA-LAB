...
/* Question 1: Create a Package mypack which contains one class Display where constructor will print the the data which it will be received. The data may be int, float, int[], String, String[].
